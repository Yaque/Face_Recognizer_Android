...
import pp.facerecognizer.manager.ManagerMain;
...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        AlertDialog editDialog = new AlertDialog.Builder(MainActivity.this)
                .setTitle(R.string.enter_manager_password)
                .setView(dialogView)
                .setPositiveButton(getString(R.string.ok), (dialogInterface, i) -> {
                    intoManager(editText.getText().toString());
                })
                .create();
...
//                finish();
    ...
    void init() {
        ...
        if (!dir.isDirectory()) {
            ...
            FileUtils.copyAsset(mgr, FileUtils.PWD_FILE);
        }
    ...
    public void intoManager(String password) {
        String pwd = FileUtils.readPwd(FileUtils.PWD_FILE);
